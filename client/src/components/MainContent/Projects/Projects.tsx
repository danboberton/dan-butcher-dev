    ...
    return (
        <div id={"projects"}>
            ...
            <SingleProject title={"Context Aware Sound Alerts"}
                           description={"A senior group project, this SPA was designed to administer a scientific " +
                               "experiment to participants and aggregate data in a mongo database. Notification " +
                               "sound effects were played randomly over 3 different background noise contexts, " +
                               "users were asked to click a button when they heard a notification sound. We then " +
                               "calculated a hit rate to investigate how different sound effect and background sound " +
                               "pairings performed. Data analysis done in python with Jupyter Notebook, pandas, and " +
                               "matplotlib."}
                           features={
                               <ul>
            ...
            <SingleProject title={"money-mate"}
                           description={"A group project for Project Management. This React SPA was designed to help " +
            ...
            <SingleProject title={"Omega Chess"}
                           description={"A group project for CS414 Object Oriented Design with a React front-end and " +
                               "Java back-end. The emphasis for this project was on architectural design of a " +
                               "Java Spark backend to implement logic for a chess game utilizing software design " +
                               "patterns. We were the only group who didn't use a chess board library, we wrote our " +
                               "own custom chessboard components. I'm currently working on porting this to a Docker " +
                               "container to run locally instead of hosted on a University server."}
                           features={
                               <ul>
                                   <li>React Single Page Application</li>
            ...
            <SingleProject title={"Global Distances Calculator"}
                           description={"This was my first exposure to a large React codebase. Our group excelled in" +
                               "implementing time-boxed REST-API endpoints with multi-threaded algorithms to find" +
                               "efficient paths to GPS coordinates."}
                           features={
                               <ul>
                                   <li>React Single Page Application</li>
                                   <li>Sprint / Agile team</li>
            ...
            <SingleProject title={"Remote SPL Calculator"}
                           description={"A remote Sound Pressure Level sensor deployed on a Raspberry Pi. The sensor" +
                               "unit would calculate current SPL and log the data back over a socket."}
                           features={
                               <ul>
                                   <li>python</li>
                                   <li>sockets</li>
